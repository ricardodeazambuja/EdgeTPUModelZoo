...
| File | Description |
|------|-------------|
| `efficientnet-edgetpu-S_quant.tflite` | Standard TFLite model (CPU) |
| `efficientnet-edgetpu-S_quant_edgetpu.tflite` | Edge TPU compiled model (Coral) |
...
# Load model
interpreter = make_interpreter("efficientnet-edgetpu-S_quant_edgetpu.tflite")
...
interpreter = tflite.Interpreter(model_path="efficientnet-edgetpu-S_quant.tflite")
interpreter.allocate_tensors()
...
| Metric | Value |
|--------|-------|
| Top-1 Accuracy (ImageNet) | 78.9% |
| Top-5 Accuracy (ImageNet) | 94.7% |
