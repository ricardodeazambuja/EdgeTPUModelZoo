# SSD MobileNet V2 COCO (with Postprocess)
...
SSD with MobileNet V2 backbone trained on COCO with built-in NMS. 90 COCO categories.

Better accuracy than V1 variant. Ready-to-use with built-in postprocessing.
...
| File | Description |
|------|-------------|
| `ssd_mobilenet_v2_coco_quant_postprocess.tflite` | Standard TFLite model (CPU) |
| `ssd_mobilenet_v2_coco_quant_postprocess_edgetpu.tflite` | Edge TPU compiled model (Coral) |
