# TF2 SSD MobileNet V2 (COCO 2017)
...
TF2 SSD with MobileNet V2 backbone for object detection on COCO 2017 (90 categories).

TF2-trained with updated pipeline for COCO 2017.
...
| File | Description |
|------|-------------|
| `tf2_ssd_mobilenet_v2_coco17_ptq.tflite` | Standard TFLite model (CPU) |
| `tf2_ssd_mobilenet_v2_coco17_ptq_edgetpu.tflite` | Edge TPU compiled model (Coral) |
...
# Load model
interpreter = make_interpreter("tf2_ssd_mobilenet_v2_coco17_ptq_edgetpu.tflite")
...
interpreter = tflite.Interpreter(model_path="tf2_ssd_mobilenet_v2_coco17_ptq.tflite")
interpreter.allocate_tensors()
...
|--------|-------|
| mAP (COCO 2017) | 22.4% |
| Edge TPU Latency | 7.6 ms |
| Model Size (Edge TPU) | 6.8 MB |
