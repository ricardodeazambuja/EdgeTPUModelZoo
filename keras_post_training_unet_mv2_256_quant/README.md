...
| File | Description |
|------|-------------|
| `keras_post_training_unet_mv2_256_quant.tflite` | Standard TFLite model (CPU) |
| `keras_post_training_unet_mv2_256_quant_edgetpu.tflite` | Edge TPU compiled model (Coral) |
...
# Load model
interpreter = make_interpreter("keras_post_training_unet_mv2_256_quant_edgetpu.tflite")
...
| Metric | Value |
|--------|-------|
| Edge TPU Latency | 29.0 ms |
| Model Size (Edge TPU) | 7.0 MB |
