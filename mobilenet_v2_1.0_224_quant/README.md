# MobileNet V2 (alpha=1.0, 224x224)
...
| File | Description |
|------|-------------|
| `mobilenet_v2_1.0_224_quant.tflite` | Standard TFLite model (CPU) |
| `mobilenet_v2_1.0_224_quant_edgetpu.tflite` | Edge TPU compiled model (Coral) |
