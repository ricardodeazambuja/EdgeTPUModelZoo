...
| File | Description |
|------|-------------|
| `tfhub_tf2_resnet_50_imagenet_ptq.tflite` | Standard TFLite model (CPU) |
| `tfhub_tf2_resnet_50_imagenet_ptq_edgetpu.tflite` | Edge TPU compiled model (Coral) |
...
# Load model
interpreter = make_interpreter("tfhub_tf2_resnet_50_imagenet_ptq_edgetpu.tflite")
...
interpreter = tflite.Interpreter(model_path="tfhub_tf2_resnet_50_imagenet_ptq.tflite")
interpreter.allocate_tensors()
