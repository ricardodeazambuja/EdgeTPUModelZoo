...
| File | Description |
|------|-------------|
| `efficientdet_lite0_320_ptq.tflite` | Standard TFLite model (CPU) |
| `efficientdet_lite0_320_ptq_edgetpu.tflite` | Edge TPU compiled model (Coral) |
...
# Load model
interpreter = make_interpreter("efficientdet_lite0_320_ptq_edgetpu.tflite")
...
interpreter = tflite.Interpreter(model_path="efficientdet_lite0_320_ptq.tflite")
interpreter.allocate_tensors()
...
|--------|-------|
| mAP (COCO 2017) | 30.4% |
| Edge TPU Latency | 37.4 ms |
| Model Size (Edge TPU) | 5.7 MB |
