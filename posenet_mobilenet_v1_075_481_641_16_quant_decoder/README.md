...
**Input:** `uint8` tensor of shape `[1, 481, 641, 3]` (batch, height, width, RGB channels), values in `[0, 255]`
...
PoseNet pose estimation at 481x641 resolution. Higher resolution for improved keypoint localization.

Output stride of 16. Higher resolution provides more accurate detection for smaller subjects.
...
| Range | `[0, 255]` |
| Color format | RGB |
| Preprocessing | Resize to 641x481, no normalization needed |
...
| File | Description |
|------|-------------|
| `posenet_mobilenet_v1_075_481_641_16_quant_decoder.tflite` | Standard TFLite model (CPU) |
| `posenet_mobilenet_v1_075_481_641_16_quant_decoder_edgetpu.tflite` | Edge TPU compiled model (Coral) |
...
# Load model
interpreter = make_interpreter("posenet_mobilenet_v1_075_481_641_16_quant_decoder_edgetpu.tflite")
