...
| Range | `[0, 255]` |
| Color format | RGB |
| Preprocessing | Resize to 192x192, no normalization needed |
...
| File | Description |
|------|-------------|
| `movenet_single_pose_lightning_ptq.tflite` | Standard TFLite model (CPU) |
| `movenet_single_pose_lightning_ptq_edgetpu.tflite` | Edge TPU compiled model (Coral) |
...
interpreter = tflite.Interpreter(model_path="movenet_single_pose_lightning_ptq.tflite")
interpreter.allocate_tensors()
