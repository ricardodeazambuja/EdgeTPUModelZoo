...
Inception V1 (GoogLeNet) image classification. Classifies images into 1000 ImageNet categories.

Inception V1 introduced the inception module with parallel convolutions at multiple scales. Efficient for edge deployment despite its age.
...
| File | Description |
|------|-------------|
| `inception_v1_224_quant.tflite` | Standard TFLite model (CPU) |
| `inception_v1_224_quant_edgetpu.tflite` | Edge TPU compiled model (Coral) |
...
# Load model
interpreter = make_interpreter("inception_v1_224_quant_edgetpu.tflite")
