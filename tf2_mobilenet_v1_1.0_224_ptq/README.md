...
MobileNet V1 trained with TensorFlow 2 and post-training quantized. 1000 ImageNet categories.

TF2-trained version with updated training techniques.
...
| File | Description |
|------|-------------|
| `tf2_mobilenet_v1_1.0_224_ptq.tflite` | Standard TFLite model (CPU) |
| `tf2_mobilenet_v1_1.0_224_ptq_edgetpu.tflite` | Edge TPU compiled model (Coral) |
...
# Load model
interpreter = make_interpreter("tf2_mobilenet_v1_1.0_224_ptq_edgetpu.tflite")
...
interpreter = tflite.Interpreter(model_path="tf2_mobilenet_v1_1.0_224_ptq.tflite")
interpreter.allocate_tensors()
