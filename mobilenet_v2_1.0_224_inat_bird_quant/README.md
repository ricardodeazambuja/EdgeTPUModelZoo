# MobileNet V2 iNaturalist Birds
...
| File | Description |
|------|-------------|
| `mobilenet_v2_1.0_224_inat_bird_quant.tflite` | Standard TFLite model (CPU) |
| `mobilenet_v2_1.0_224_inat_bird_quant_edgetpu.tflite` | Edge TPU compiled model (Coral) |

## Labels

The file `inat_bird_labels.txt` maps output indices to human-readable class names.
