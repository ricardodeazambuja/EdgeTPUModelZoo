...
PoseNet pose estimation with MobileNet V1 backbone (alpha=0.75). Detects 17 body keypoints at 353x481 resolution. Decoder variant with built-in heatmap decoding.

Output stride of 16. Decoder produces keypoint coordinates directly rather than raw heatmaps.
...
| Range | `[0, 255]` |
| Color format | RGB |
| Preprocessing | Resize to 481x353, no normalization needed |
...
| File | Description |
|------|-------------|
| `posenet_mobilenet_v1_075_353_481_16_quant_decoder.tflite` | Standard TFLite model (CPU) |
| `posenet_mobilenet_v1_075_353_481_16_quant_decoder_edgetpu.tflite` | Edge TPU compiled model (Coral) |
...
# Load model
interpreter = make_interpreter("posenet_mobilenet_v1_075_353_481_16_quant_decoder_edgetpu.tflite")
