...
EfficientDet-Lite3x is the largest and most accurate Lite variant with 640x640 input for 90 COCO categories.

Highest accuracy among EfficientDet-Lite variants. Best for applications where detection quality is critical.
...
| File | Description |
|------|-------------|
| `efficientdet_lite3x_640_ptq.tflite` | Standard TFLite model (CPU) |
| `efficientdet_lite3x_640_ptq_edgetpu.tflite` | Edge TPU compiled model (Coral) |
...
# Load model
interpreter = make_interpreter("efficientdet_lite3x_640_ptq_edgetpu.tflite")
...
interpreter = tflite.Interpreter(model_path="efficientdet_lite3x_640_ptq.tflite")
interpreter.allocate_tensors()
